...
\begin{table}[H]
    ...
    \end{tabular}
    \caption{OpenMP = OMP. Benchmark results for running the different iteration of the code
...
We did not get to optimizing the \texttt{TRIDAG\_SOLVER} in the project, but this afterwards, as we did not get to use it.
}
